package com.sparta.rh.testFirstDevelopment;

import org.example.com.sparta.rh.testFirstDevelopment.Methods;
...
public class CheckInputTest {
    ...
    @ParameterizedTest@ValueSource(strings = {"PASS", "word", "chicken", ""})
